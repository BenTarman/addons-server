...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        addon_report_html = self.generate_report_html(
            'addon', addon_report_data
        )
        ...
        content_report_html = self.generate_report_html(
            'content', content_report_data
        )
