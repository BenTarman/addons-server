...
def queue_recommended(request):
    return _queue(
        request, view_table_factory(ViewRecommendedQueue), 'recommended'
    )
...
def queue_theme_nominated(request):
    return _queue(
        request,
        view_table_factory(ViewThemeFullReviewQueue),
        'theme_nominated',
    )
...
def queue_theme_pending(request):
    return _queue(
        request, view_table_factory(ViewThemePendingQueue), 'theme_pending'
    )
