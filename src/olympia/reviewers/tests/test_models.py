...
class TestAutoApprovalSummary(TestCase):
    ...
    def test_check_is_recommendable(self):
        assert (
            AutoApprovalSummary.check_is_recommendable(self.version) is False
        )
    ...
    def test_check_should_be_delayed(self):
        assert (
            AutoApprovalSummary.check_should_be_delayed(self.version) is False
        )
        ...
        assert (
            AutoApprovalSummary.check_should_be_delayed(self.version) is True
        )
