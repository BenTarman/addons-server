...
detail_patterns = [
    ...
    url(
        r'^versions/stats$', views.version_stats, name='devhub.versions.stats'
    ),
    url(
    ...
    url(
        r'^request-review$', views.request_review, name='devhub.request-review'
    ),
    url(
        r'^rmlocale$', views.remove_locale, name='devhub.addons.remove-locale'
    ),
]
...
ajax_patterns = [
    ...
    url(
        r'^image/status$', views.image_status, name='devhub.ajax.image.status'
    ),
]
redirect_patterns = [
    url(
